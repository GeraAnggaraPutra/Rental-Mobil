            ...
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
              <form action="{{ route('register') }}" method="post">
                ...
                <div class="form-outline mb-4">
                    ...
                    <input type="text" id="form3Example3" class="form-control form-control-lg @error('name') is-invalid @enderror"
                      placeholder="Enter Username" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus/>
                    @error('name')
                ...
                <div class="text-center text-lg-start mt-4 pt-2">
                  ...
                  <p class="small fw-bold mt-2 pt-1 mb-0">I already have a account <a href="{{ route('login') }}"
