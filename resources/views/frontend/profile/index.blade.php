            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-sm-6 mb-3">
                        ...
                        <input type="text" name="nama" placeholder="nama"
                            class="form-control @error('name') is-invalid @enderror" value="{{Auth::user()->detailUser->nama}}">
                        @error('name')
                    ...
                    <div class="col-sm-6 col-md-6">
                        ...
                        <input type="number" name="nik" placeholder="nik"
                            class="form-control @error('nik') is-invalid @enderror" value="{{Auth::user()->detailUser->nik}}">
                        @error('nik')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-6 mt-3">
                        ...
                        <input type="number" name="no_telp" placeholder="No Telepon"
                            class="form-control @error('no_telp') is-invalid @enderror" value="{{Auth::user()->detailUser->no_telp}}">
                        @error('no_telp')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-sm-6 col-md-6 mt-3">
                        ...
                        <input type="email" name="email" placeholder="email"
                            class="form-control @error('email') is-invalid @enderror" value="{{Auth::user()->detailUser->email}}">
                        @error('email')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-6 mt-3">
                        ...
                        <div class="form-check">
                            <input
                                ...
                                type="radio" name="jenis_kelamin" value="Laki-laki" @if(Auth::user()->detailUser->jenis_kelamin == 'Laki-laki') checked @endif>
                        ...
                        <div class="form-check">
                            <input
                                class="form-check-input @error('jenis_kelamin') is-invalid @enderror"
                                type="radio" name="jenis_kelamin" value="Perempuan" @if(Auth::user()->detailUser->jenis_kelamin == 'Perempuan') checked @endif>
                            <label class="form-check-label">
                                Perempuan
                            </label>
                        </div>
                    ...
                    <div class="col-sm-6 col-md-6 mt-3">
                        ...
                        class="form-control @error('alamat') is-invalid @enderror" value="{{Auth::user()->detailUser->alamat}}">
                        @error('alamat')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
